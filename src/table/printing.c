    ...
    struct Cell *right_above, struct Cell *left_below, struct Cell *right_below)
{
    ...
    if (right_above != NULL)
    {
        ...
        if (above == BORDER_SINGLE) num_single++;
        if (above == BORDER_DOUBLE) num_double++;
    }
    ...
    if (right_below != NULL)
    {
        ...
        if (right == BORDER_SINGLE) num_single++;
        if (right == BORDER_DOUBLE) num_double++;
    }
    ...
    if (right_below != NULL)
    {
        ...
        if (below == BORDER_SINGLE) num_single++;
        if (below == BORDER_DOUBLE) num_double++;
    }
    ...
    if (left_below != NULL)
    {
        ...
        if (left == BORDER_SINGLE) num_single++;
        if (left == BORDER_DOUBLE) num_double++;
    }
